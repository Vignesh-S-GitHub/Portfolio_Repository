...
from data_Pipeline.kafka_producer import kafka_producer  # Import producer script
from data_Pipeline.kafka_consumer import kafka_to_postgres  # Import consumer script
